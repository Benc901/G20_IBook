 ...
 * frame with few fields that the user should select and insert text for searching any review
 * after the user press the result of review details shown on the table inside the screen
 */
